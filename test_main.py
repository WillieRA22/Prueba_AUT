...
#Para deshacerse de los errores de certificado
...
def test_pruebaButton():
    ...
    driver.get_screenshot_as_file('C:\\Users\\DELL E7240\\Desktop\\Prueba_SE\\screenshot\\prueba_button.png')
    assert True
...
def test_pruebaLogin():
    ...
    element_email.send_keys('20210009@itla.edu.do')

    element_password = driver.find_element(By.ID, 'app_user_password')
    element_password.send_keys('20210009' + Keys.ENTER)
    driver.get_screenshot_as_file('C:\\Users\\DELL E7240\\Desktop\\Prueba_SE\\screenshot\\prueba_login.png')
    assert True
...
def test_pruebaSearch():
    ...
    driver.get_screenshot_as_file('C:\\Users\\DELL E7240\\Desktop\\Prueba_SE\\screenshot\\prueba_search.png')
    assert True
...
def test_pruebaLogo():
    ...
    driver.get_screenshot_as_file('C:\\Users\\DELL E7240\\Desktop\\Prueba_SE\\screenshot\\prueba_logo.png')
    assert True
...
def test_pruebaFavorites():
    ...
    driver.get_screenshot_as_file('C:\\Users\\DELL E7240\\Desktop\\Prueba_SE\\screenshot\\prueba_buttonFavorites.png')
    assert True
